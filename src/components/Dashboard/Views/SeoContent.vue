  ...
  <div class="content">
          ...
          <card>
            <template slot="header">
              <div class="row">
                ...
                <div class="col-4">
                  <router-link class="btn btn-info btn-fill float-right" to="/admin/addseocontent">
                    Add Content
                  </router-link>
                </div>
             </div>
    ...
    <tbody>
      <tr v-for="(slide,k,index) in table1" :k="k">
        ...
        <td>
          <router-link class="btn btn-info btn-fill btn-xs" :to="'/admin/editseocontent/' + slide._id">Edit</router-link>  </td>
      </tr>
