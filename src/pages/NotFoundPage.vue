    ...
    <nav class="navbar navbar-ct-default" role="navigation-demo">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <router-link :to="{path:'/'}" class="navbar-brand">Mindzcloud Admin</router-link>
        </div>
    ...
    <footer class="footer-demo">
      <div class="container">
        ...
        <div class="copyright pull-right">
          &copy; Design & Developed by <a href="https://mindzcloudstage.herokuapp.com/" target="_blank"> Mindzcloud</a>.
        </div>
      </div>
    </footer>
  </div>
